...
{
	SYS_LOG_DBG("RTC_TSR: %x", base->TSR);
	SYS_LOG_DBG("RTC_TPR: %x", base->TPR);
	SYS_LOG_DBG("RTC_TAR: %x", base->TAR);
	SYS_LOG_DBG("RTC_TCR: %x", base->TCR);
	SYS_LOG_DBG("RTC_CR:  %x", base->CR);
	SYS_LOG_DBG("RTC_SR:  %x", base->SR);
	SYS_LOG_DBG("RTC_LR:  %x", base->LR);
	SYS_LOG_DBG("RTC_IER: %x", base->IER);
	SYS_LOG_DBG("RTC_WAR: %x", base->WAR);
	SYS_LOG_DBG("RTC_RAR: %x", base->RAR);
}
